...
| `skills_garmin.md` | ONLY when generating Garmin running workout JSON |
| `skills_gym.md` | ONLY when generating Garmin strength/gym workout JSON |
...
- When asked to create a Garmin **running** workout → read `skills_garmin.md`, use template, save JSON to `garmin_workouts/upcoming/`
- When asked to create a Garmin **strength/gym** workout → read `skills_gym.md`, save JSON to `garmin_workouts/gym/`
